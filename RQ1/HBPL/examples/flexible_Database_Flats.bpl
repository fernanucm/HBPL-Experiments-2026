...
%% RULES
%% flat_distric(Flat, Flat_Dist)
flat_distric(Flat, Flat_Dist) :- flat(Flat, Street, _, _), street(Street, Flat_Dist).

%% close_to(Flat, District) 
close_to(Flat, District):-flat_distric(Flat, Flat_Dist), distance(Flat_Dist, District, close).
