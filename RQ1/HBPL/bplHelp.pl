...
bpl_help :-
	...
	write('tm ... (time) executes a query and shows time statistics\n'),
	write('ti ... (timing) sets time statistics for any input\n'),
	...
	write('hy ... (hypothetical) prints or sets hypothetical mode\n'),
	...
	write('sp ... (spy) sets a spy point on a Prolog predicate\n'),
	write('st ... (status) displays the current status of the Bousi~Prolog system\n'),
...
command_help(tm) :-
	...
	write('TIME\n'),
	nl,
	write('[Extracted and adapted from SWI-Prolog documentation:]\n'),
	nl,
	write('Executes a query just like sv and prints time used, number of logical\n'),
	write('inferences and the average number of lips (logical inferences per second).\n'),
	nl,
	write('Note that SWI-Prolog counts the actual executed number of inferences rather\n'),
	write('than the number of passes through the call and redo ports of the theoretical\n'),
	write('4-port model. If the query is non-deterministic, prints statistics for each\n'),
	write('solution, where the reported values are relative to the previous answer.\n'),
	nl,
	write('Syntax:\n'),
	write('tm <query> ...... solves <query> using WSLD resolution and shows time\n'),
	write('                  statistics\n'),
	write('----------------------------------------------------------------------------\n').
...
command_help(ti) :-
	...
	write('TIMING\n'),
	nl,
	write('Enables or disables time statistics for any input.\n'),
	write('See also TIME.\n'),
	nl,
	write('Syntax:\n'),
	write('ti <boolean> .... if <boolean> is ''true'', shows time statistics for any input;\n'),
	write('                  if ''false'', do not\n'),
	write('----------------------------------------------------------------------------\n').
...
command_help(hy) :-
	...
	write('HYPOTHETICAL\n'),
	nl,
	write('Prints or sets whether hypothetical mode is enabled or not. When used to \n'),
	write('set a new value, this command overrides the hypothetical/1 directive that\n'),
	write('may be present in the already loaded program.\n'),
	nl,
	write('Hypothetical mode is disabled by default. When changed, the loaded program,\n'),
	write('if any, is recompiled.\n'),
	nl,
	write('Syntax:\n'),
	write('hy .............. prints whether hypothetical mode is enabled or not\n'),
	write('hy <boolean> .... sets <boolean> as the new value, which must be\n'),
	write('                  a Boolean (either \'true\' or \'false\')\n'),
	write('----------------------------------------------------------------------------\n').
...
command_help(ts) :-
	...
	write('TEST\n'),
	nl,
	write('Test the system with a bundle of test programs. The current directory must\n'),
	write('be the installation directory. \n'),
	nl,
	write('Syntax:\n'),
...
command_help(bk) :-
	...
	write('BREAK\n'),
	nl,
	write('Leaves the Bousi~Prolog system and enter underlying Prolog.\n'),
	write('Type either main. to restart the system or exit. to continue.\n'),
	nl,
	write('Syntax:\n'),
...
command_help(sp) :-
	...
	write('SPY\n'),
	nl,
	write('Sets a spy point on a Prolog predicate for debugging\n'),
	write('the Bousi~Prolog system implementation.\n'),
	nl,
	write('Syntax:\n'),
	write('sp <predicate> ....... sets a spy point on <predicate>\n'),
	write('----------------------------------------------------------------------------\n').
...
command_help(st) :-
	...
	write('STATUS\n'),
	nl,
	write('Displays the current status of the Bousi~Prolog system:\n'),
	write('   - Indexing.\n'),
	write('   - Filtering.\n'),
	write('   - Weak unification algorithm.\n'),
	write('   - Degree accumulator.\n'),
	write('   - Hypothetical mode.\n'),
	nl,
	write('Syntax:\n'),
	write('st ..... displays the status of the Bousi~Prolog system\n'),
	write('----------------------------------------------------------------------------\n').
