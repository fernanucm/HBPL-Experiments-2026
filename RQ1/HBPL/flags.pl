...
%% remove_all_bpl_flag(+Flag)
%
%     Removes all instances of Flag from the current system flags. 
%

remove_all_bpl_flag(Flag) :-
	retractall(bpl_flags(Flag)).
...
reset_bpl_flags :-
	...
	reset_lambda_cut,
	reset_filtering,
	reset_filtering_warning,
	reset_degree_accumulator,
	reset_indexing,
	reset_ontology_warning,
	reset_wordnet_loaded,
...
%% reset_filtering_warning
%
%     Sets the default filtering warning setting in BPL flags.
%

reset_filtering_warning :-
	default_filtering_warning(Boolean),
	set_bpl_flag(filtering_warning(Boolean)).


%% reset_indexing
%
%     Sets the default indexing in BPL flags.
%

reset_indexing :-
	default_indexing(Boolean),
	set_bpl_flag(indexing(Boolean)).
...
reset_degree_accumulator :-
	default_degree_accumulator(Boolean),
	set_bpl_flag(degree_accumulator(Boolean)).


%% reset_ontology_warning
%
%     Sets the default ontology warning setting in BPL flags.
%

reset_ontology_warning :-
	default_ontology_warning(Boolean),
	set_bpl_flag(ontology_warning(Boolean)).


%% reset_wordnet_loaded
%
%     Sets default loaded status of WordNet.
%

reset_wordnet_loaded :-
	default_wordnet_loaded(Boolean),
	set_bpl_flag(wordnet_loaded(Boolean)).
...
%% reset_hypothetical
%
%     Sets the default hypothetical in BPL flags.
%

reset_hypothetical :-
	default_hypothetical(Boolean),
	set_bpl_flag(hypothetical(Boolean)),
	directives:set_hypothetical_operators(Boolean).


%% reset_disjunction
%
%     Sets the default disjunction in BPL flags.
%

reset_disjunction :-
	default_disjunction(Boolean),
	set_bpl_flag(disjunction(Boolean)).
...
%% default_filtering_warning(?Value)
%
%     Unifies Value with the default filtering warning value (this value can be
%     either 'true' for enabling filtering warning, or 'false' for disabling it).
%     By default, this value is 'true'.
%

default_filtering_warning(true).


%% default_indexing(?Value)
%
%     Unifies Value with the default indexing value (this value can be
%     either 'true' for enabling indexing, or 'false' for disabling it).
%     By default, this value is 'true'.
%

default_indexing(true).


%% default_degree_accumulator(?Value)
%
%     Unifies Value with the default degree accumulator value (this value 
%     can be either 'true' for enabling degree accumulator optimization,
%     or 'false' for disabling it).
%     By default, this value is 'true'.
%

default_degree_accumulator(true).


%% default_ontology_warning(?Value)
%
%     Unifies Value with the default ontology warning value (this value can be
%     either 'true' for enabling ontology warning, or 'false' for disabling it).
%     By default, this value is 'true'.
%

default_ontology_warning(true).


%% default_wordnet_loaded(?Value)
%
%     Unifies Value with the default WordNet load status (this value can be
%     either 'true' for WordNet loaded, or 'false' otherwise).
%     By default, this value is 'false'.
%

default_wordnet_loaded(false).
...
%
%     Unifies Value with the default. By default, this value is 'false', 
%     meaning that timing is not clocked. If set to 'true', each 
%     input is given statistics about timing.
%
...
%% default_hypothetical(?Value)
%
%     Unifies Value with the default hypothetical value (this value can be
%     either 'true' for enabling hypothetical mode, or 'false' for disabling it).
%     By default, this value is 'false'.
%

default_hypothetical(false).


%% disjunction(?Value)
%
%     Unifies Value with the default disjunction scanning (this value can be
%     either 'true' for indicating there is a disjunction, or 'false' otherwise).
%     By default, this value is 'false'.
%

default_disjunction(false).
