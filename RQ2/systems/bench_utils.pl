...
% :- op(1020, xfy, [/\]).     % Hypothetical conjunction
...
%    write(Stream, ':- op(1020, xfy, [/\\]).     % Hypothetical conjunction\n'),
...
% % stat_start(-RT, -T), Initialization procedure. 
...
% % stat_end(+RT, +T, +I, +G, +L, +H, RTime, CTime),
% % RT, T must be: RT the runtime, T the user CPU time
