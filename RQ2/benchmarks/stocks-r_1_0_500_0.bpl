...
% Chained operational rules (H = 500)
invest_1(Name, Stock) :- 
...
invest_256(Name, Stock) :- 
    ...
    invest_257(Name, Stock).

invest_257(Name, Stock) :- 
    shareholder(Name, stock_257) => 
    (stock_up(stock_257) with 0.6) => 
    invest_258(Name, Stock).

invest_258(Name, Stock) :- 
    shareholder(Name, stock_258) => 
    (stock_up(stock_258) with 0.7) => 
    invest_259(Name, Stock).

invest_259(Name, Stock) :- 
    shareholder(Name, stock_259) => 
    (stock_up(stock_259) with 0.7) => 
    invest_260(Name, Stock).

invest_260(Name, Stock) :- 
    shareholder(Name, stock_260) => 
    (stock_up(stock_260) with 0.5) => 
    invest_261(Name, Stock).

invest_261(Name, Stock) :- 
    shareholder(Name, stock_261) => 
    (stock_up(stock_261) with 0.6) => 
    invest_262(Name, Stock).

invest_262(Name, Stock) :- 
    shareholder(Name, stock_262) => 
    (stock_up(stock_262) with 0.6) => 
    invest_263(Name, Stock).

invest_263(Name, Stock) :- 
    shareholder(Name, stock_263) => 
    (stock_up(stock_263) with 0.7) => 
    invest_264(Name, Stock).

invest_264(Name, Stock) :- 
    shareholder(Name, stock_264) => 
    (stock_up(stock_264) with 0.7) => 
    invest_265(Name, Stock).

invest_265(Name, Stock) :- 
    shareholder(Name, stock_265) => 
    (stock_up(stock_265) with 0.5) => 
    invest_266(Name, Stock).

invest_266(Name, Stock) :- 
    shareholder(Name, stock_266) => 
    (stock_up(stock_266) with 0.6) => 
    invest_267(Name, Stock).

invest_267(Name, Stock) :- 
    shareholder(Name, stock_267) => 
    (stock_up(stock_267) with 0.6) => 
    invest_268(Name, Stock).

invest_268(Name, Stock) :- 
    shareholder(Name, stock_268) => 
    (stock_up(stock_268) with 0.7) => 
    invest_269(Name, Stock).

invest_269(Name, Stock) :- 
    shareholder(Name, stock_269) => 
    (stock_up(stock_269) with 0.7) => 
    invest_270(Name, Stock).

invest_270(Name, Stock) :- 
    shareholder(Name, stock_270) => 
    (stock_up(stock_270) with 0.5) => 
    invest_271(Name, Stock).

invest_271(Name, Stock) :- 
    shareholder(Name, stock_271) => 
    (stock_up(stock_271) with 0.6) => 
    invest_272(Name, Stock).

invest_272(Name, Stock) :- 
    shareholder(Name, stock_272) => 
    (stock_up(stock_272) with 0.6) => 
    invest_273(Name, Stock).

invest_273(Name, Stock) :- 
    shareholder(Name, stock_273) => 
    (stock_up(stock_273) with 0.7) => 
    invest_274(Name, Stock).

invest_274(Name, Stock) :- 
    shareholder(Name, stock_274) => 
    (stock_up(stock_274) with 0.7) => 
    invest_275(Name, Stock).

invest_275(Name, Stock) :- 
    shareholder(Name, stock_275) => 
    (stock_up(stock_275) with 0.5) => 
    invest_276(Name, Stock).

invest_276(Name, Stock) :- 
    shareholder(Name, stock_276) => 
    (stock_up(stock_276) with 0.6) => 
    invest_277(Name, Stock).

invest_277(Name, Stock) :- 
    shareholder(Name, stock_277) => 
    (stock_up(stock_277) with 0.6) => 
    invest_278(Name, Stock).

invest_278(Name, Stock) :- 
    shareholder(Name, stock_278) => 
    (stock_up(stock_278) with 0.7) => 
    invest_279(Name, Stock).

invest_279(Name, Stock) :- 
    shareholder(Name, stock_279) => 
    (stock_up(stock_279) with 0.7) => 
    invest_280(Name, Stock).

invest_280(Name, Stock) :- 
    shareholder(Name, stock_280) => 
    (stock_up(stock_280) with 0.5) => 
    invest_281(Name, Stock).

invest_281(Name, Stock) :- 
    shareholder(Name, stock_281) => 
    (stock_up(stock_281) with 0.6) => 
    invest_282(Name, Stock).

invest_282(Name, Stock) :- 
    shareholder(Name, stock_282) => 
    (stock_up(stock_282) with 0.6) => 
    invest_283(Name, Stock).

invest_283(Name, Stock) :- 
    shareholder(Name, stock_283) => 
    (stock_up(stock_283) with 0.7) => 
    invest_284(Name, Stock).

invest_284(Name, Stock) :- 
    shareholder(Name, stock_284) => 
    (stock_up(stock_284) with 0.7) => 
    invest_285(Name, Stock).

invest_285(Name, Stock) :- 
    shareholder(Name, stock_285) => 
    (stock_up(stock_285) with 0.5) => 
    invest_286(Name, Stock).

invest_286(Name, Stock) :- 
    shareholder(Name, stock_286) => 
    (stock_up(stock_286) with 0.6) => 
    invest_287(Name, Stock).

invest_287(Name, Stock) :- 
    shareholder(Name, stock_287) => 
    (stock_up(stock_287) with 0.6) => 
    invest_288(Name, Stock).

invest_288(Name, Stock) :- 
    shareholder(Name, stock_288) => 
    (stock_up(stock_288) with 0.7) => 
    invest_289(Name, Stock).

invest_289(Name, Stock) :- 
    shareholder(Name, stock_289) => 
    (stock_up(stock_289) with 0.7) => 
    invest_290(Name, Stock).

invest_290(Name, Stock) :- 
    shareholder(Name, stock_290) => 
    (stock_up(stock_290) with 0.5) => 
    invest_291(Name, Stock).

invest_291(Name, Stock) :- 
    shareholder(Name, stock_291) => 
    (stock_up(stock_291) with 0.6) => 
    invest_292(Name, Stock).

invest_292(Name, Stock) :- 
    shareholder(Name, stock_292) => 
    (stock_up(stock_292) with 0.6) => 
    invest_293(Name, Stock).

invest_293(Name, Stock) :- 
    shareholder(Name, stock_293) => 
    (stock_up(stock_293) with 0.7) => 
    invest_294(Name, Stock).

invest_294(Name, Stock) :- 
    shareholder(Name, stock_294) => 
    (stock_up(stock_294) with 0.7) => 
    invest_295(Name, Stock).

invest_295(Name, Stock) :- 
    shareholder(Name, stock_295) => 
    (stock_up(stock_295) with 0.5) => 
    invest_296(Name, Stock).

invest_296(Name, Stock) :- 
    shareholder(Name, stock_296) => 
    (stock_up(stock_296) with 0.6) => 
    invest_297(Name, Stock).

invest_297(Name, Stock) :- 
    shareholder(Name, stock_297) => 
    (stock_up(stock_297) with 0.6) => 
    invest_298(Name, Stock).

invest_298(Name, Stock) :- 
    shareholder(Name, stock_298) => 
    (stock_up(stock_298) with 0.7) => 
    invest_299(Name, Stock).

invest_299(Name, Stock) :- 
    shareholder(Name, stock_299) => 
    (stock_up(stock_299) with 0.7) => 
    invest_300(Name, Stock).

invest_300(Name, Stock) :- 
    shareholder(Name, stock_300) => 
    (stock_up(stock_300) with 0.5) => 
    invest_301(Name, Stock).

invest_301(Name, Stock) :- 
    shareholder(Name, stock_301) => 
    (stock_up(stock_301) with 0.6) => 
    invest_302(Name, Stock).

invest_302(Name, Stock) :- 
    shareholder(Name, stock_302) => 
    (stock_up(stock_302) with 0.6) => 
    invest_303(Name, Stock).

invest_303(Name, Stock) :- 
    shareholder(Name, stock_303) => 
    (stock_up(stock_303) with 0.7) => 
    invest_304(Name, Stock).

invest_304(Name, Stock) :- 
    shareholder(Name, stock_304) => 
    (stock_up(stock_304) with 0.7) => 
    invest_305(Name, Stock).

invest_305(Name, Stock) :- 
    shareholder(Name, stock_305) => 
    (stock_up(stock_305) with 0.5) => 
    invest_306(Name, Stock).

invest_306(Name, Stock) :- 
    shareholder(Name, stock_306) => 
    (stock_up(stock_306) with 0.6) => 
    invest_307(Name, Stock).

invest_307(Name, Stock) :- 
    shareholder(Name, stock_307) => 
    (stock_up(stock_307) with 0.6) => 
    invest_308(Name, Stock).

invest_308(Name, Stock) :- 
    shareholder(Name, stock_308) => 
    (stock_up(stock_308) with 0.7) => 
    invest_309(Name, Stock).

invest_309(Name, Stock) :- 
    shareholder(Name, stock_309) => 
    (stock_up(stock_309) with 0.7) => 
    invest_310(Name, Stock).

invest_310(Name, Stock) :- 
    shareholder(Name, stock_310) => 
    (stock_up(stock_310) with 0.5) => 
    invest_311(Name, Stock).

invest_311(Name, Stock) :- 
    shareholder(Name, stock_311) => 
    (stock_up(stock_311) with 0.6) => 
    invest_312(Name, Stock).

invest_312(Name, Stock) :- 
    shareholder(Name, stock_312) => 
    (stock_up(stock_312) with 0.6) => 
    invest_313(Name, Stock).

invest_313(Name, Stock) :- 
    shareholder(Name, stock_313) => 
    (stock_up(stock_313) with 0.7) => 
    invest_314(Name, Stock).

invest_314(Name, Stock) :- 
    shareholder(Name, stock_314) => 
    (stock_up(stock_314) with 0.7) => 
    invest_315(Name, Stock).

invest_315(Name, Stock) :- 
    shareholder(Name, stock_315) => 
    (stock_up(stock_315) with 0.5) => 
    invest_316(Name, Stock).

invest_316(Name, Stock) :- 
    shareholder(Name, stock_316) => 
    (stock_up(stock_316) with 0.6) => 
    invest_317(Name, Stock).

invest_317(Name, Stock) :- 
    shareholder(Name, stock_317) => 
    (stock_up(stock_317) with 0.6) => 
    invest_318(Name, Stock).

invest_318(Name, Stock) :- 
    shareholder(Name, stock_318) => 
    (stock_up(stock_318) with 0.7) => 
    invest_319(Name, Stock).

invest_319(Name, Stock) :- 
    shareholder(Name, stock_319) => 
    (stock_up(stock_319) with 0.7) => 
    invest_320(Name, Stock).

invest_320(Name, Stock) :- 
    shareholder(Name, stock_320) => 
    (stock_up(stock_320) with 0.5) => 
    invest_321(Name, Stock).

invest_321(Name, Stock) :- 
    shareholder(Name, stock_321) => 
    (stock_up(stock_321) with 0.6) => 
    invest_322(Name, Stock).

invest_322(Name, Stock) :- 
    shareholder(Name, stock_322) => 
    (stock_up(stock_322) with 0.6) => 
    invest_323(Name, Stock).

invest_323(Name, Stock) :- 
    shareholder(Name, stock_323) => 
    (stock_up(stock_323) with 0.7) => 
    invest_324(Name, Stock).

invest_324(Name, Stock) :- 
    shareholder(Name, stock_324) => 
    (stock_up(stock_324) with 0.7) => 
    invest_325(Name, Stock).

invest_325(Name, Stock) :- 
    shareholder(Name, stock_325) => 
    (stock_up(stock_325) with 0.5) => 
    invest_326(Name, Stock).

invest_326(Name, Stock) :- 
    shareholder(Name, stock_326) => 
    (stock_up(stock_326) with 0.6) => 
    invest_327(Name, Stock).

invest_327(Name, Stock) :- 
    shareholder(Name, stock_327) => 
    (stock_up(stock_327) with 0.6) => 
    invest_328(Name, Stock).

invest_328(Name, Stock) :- 
    shareholder(Name, stock_328) => 
    (stock_up(stock_328) with 0.7) => 
    invest_329(Name, Stock).

invest_329(Name, Stock) :- 
    shareholder(Name, stock_329) => 
    (stock_up(stock_329) with 0.7) => 
    invest_330(Name, Stock).

invest_330(Name, Stock) :- 
    shareholder(Name, stock_330) => 
    (stock_up(stock_330) with 0.5) => 
    invest_331(Name, Stock).

invest_331(Name, Stock) :- 
    shareholder(Name, stock_331) => 
    (stock_up(stock_331) with 0.6) => 
    invest_332(Name, Stock).

invest_332(Name, Stock) :- 
    shareholder(Name, stock_332) => 
    (stock_up(stock_332) with 0.6) => 
    invest_333(Name, Stock).

invest_333(Name, Stock) :- 
    shareholder(Name, stock_333) => 
    (stock_up(stock_333) with 0.7) => 
    invest_334(Name, Stock).

invest_334(Name, Stock) :- 
    shareholder(Name, stock_334) => 
    (stock_up(stock_334) with 0.7) => 
    invest_335(Name, Stock).

invest_335(Name, Stock) :- 
    shareholder(Name, stock_335) => 
    (stock_up(stock_335) with 0.5) => 
    invest_336(Name, Stock).

invest_336(Name, Stock) :- 
    shareholder(Name, stock_336) => 
    (stock_up(stock_336) with 0.6) => 
    invest_337(Name, Stock).

invest_337(Name, Stock) :- 
    shareholder(Name, stock_337) => 
    (stock_up(stock_337) with 0.6) => 
    invest_338(Name, Stock).

invest_338(Name, Stock) :- 
    shareholder(Name, stock_338) => 
    (stock_up(stock_338) with 0.7) => 
    invest_339(Name, Stock).

invest_339(Name, Stock) :- 
    shareholder(Name, stock_339) => 
    (stock_up(stock_339) with 0.7) => 
    invest_340(Name, Stock).

invest_340(Name, Stock) :- 
    shareholder(Name, stock_340) => 
    (stock_up(stock_340) with 0.5) => 
    invest_341(Name, Stock).

invest_341(Name, Stock) :- 
    shareholder(Name, stock_341) => 
    (stock_up(stock_341) with 0.6) => 
    invest_342(Name, Stock).

invest_342(Name, Stock) :- 
    shareholder(Name, stock_342) => 
    (stock_up(stock_342) with 0.6) => 
    invest_343(Name, Stock).

invest_343(Name, Stock) :- 
    shareholder(Name, stock_343) => 
    (stock_up(stock_343) with 0.7) => 
    invest_344(Name, Stock).

invest_344(Name, Stock) :- 
    shareholder(Name, stock_344) => 
    (stock_up(stock_344) with 0.7) => 
    invest_345(Name, Stock).

invest_345(Name, Stock) :- 
    shareholder(Name, stock_345) => 
    (stock_up(stock_345) with 0.5) => 
    invest_346(Name, Stock).

invest_346(Name, Stock) :- 
    shareholder(Name, stock_346) => 
    (stock_up(stock_346) with 0.6) => 
    invest_347(Name, Stock).

invest_347(Name, Stock) :- 
    shareholder(Name, stock_347) => 
    (stock_up(stock_347) with 0.6) => 
    invest_348(Name, Stock).

invest_348(Name, Stock) :- 
    shareholder(Name, stock_348) => 
    (stock_up(stock_348) with 0.7) => 
    invest_349(Name, Stock).

invest_349(Name, Stock) :- 
    shareholder(Name, stock_349) => 
    (stock_up(stock_349) with 0.7) => 
    invest_350(Name, Stock).

invest_350(Name, Stock) :- 
    shareholder(Name, stock_350) => 
    (stock_up(stock_350) with 0.5) => 
    invest_351(Name, Stock).

invest_351(Name, Stock) :- 
    shareholder(Name, stock_351) => 
    (stock_up(stock_351) with 0.6) => 
    invest_352(Name, Stock).

invest_352(Name, Stock) :- 
    shareholder(Name, stock_352) => 
    (stock_up(stock_352) with 0.6) => 
    invest_353(Name, Stock).

invest_353(Name, Stock) :- 
    shareholder(Name, stock_353) => 
    (stock_up(stock_353) with 0.7) => 
    invest_354(Name, Stock).

invest_354(Name, Stock) :- 
    shareholder(Name, stock_354) => 
    (stock_up(stock_354) with 0.7) => 
    invest_355(Name, Stock).

invest_355(Name, Stock) :- 
    shareholder(Name, stock_355) => 
    (stock_up(stock_355) with 0.5) => 
    invest_356(Name, Stock).

invest_356(Name, Stock) :- 
    shareholder(Name, stock_356) => 
    (stock_up(stock_356) with 0.6) => 
    invest_357(Name, Stock).

invest_357(Name, Stock) :- 
    shareholder(Name, stock_357) => 
    (stock_up(stock_357) with 0.6) => 
    invest_358(Name, Stock).

invest_358(Name, Stock) :- 
    shareholder(Name, stock_358) => 
    (stock_up(stock_358) with 0.7) => 
    invest_359(Name, Stock).

invest_359(Name, Stock) :- 
    shareholder(Name, stock_359) => 
    (stock_up(stock_359) with 0.7) => 
    invest_360(Name, Stock).

invest_360(Name, Stock) :- 
    shareholder(Name, stock_360) => 
    (stock_up(stock_360) with 0.5) => 
    invest_361(Name, Stock).

invest_361(Name, Stock) :- 
    shareholder(Name, stock_361) => 
    (stock_up(stock_361) with 0.6) => 
    invest_362(Name, Stock).

invest_362(Name, Stock) :- 
    shareholder(Name, stock_362) => 
    (stock_up(stock_362) with 0.6) => 
    invest_363(Name, Stock).

invest_363(Name, Stock) :- 
    shareholder(Name, stock_363) => 
    (stock_up(stock_363) with 0.7) => 
    invest_364(Name, Stock).

invest_364(Name, Stock) :- 
    shareholder(Name, stock_364) => 
    (stock_up(stock_364) with 0.7) => 
    invest_365(Name, Stock).

invest_365(Name, Stock) :- 
    shareholder(Name, stock_365) => 
    (stock_up(stock_365) with 0.5) => 
    invest_366(Name, Stock).

invest_366(Name, Stock) :- 
    shareholder(Name, stock_366) => 
    (stock_up(stock_366) with 0.6) => 
    invest_367(Name, Stock).

invest_367(Name, Stock) :- 
    shareholder(Name, stock_367) => 
    (stock_up(stock_367) with 0.6) => 
    invest_368(Name, Stock).

invest_368(Name, Stock) :- 
    shareholder(Name, stock_368) => 
    (stock_up(stock_368) with 0.7) => 
    invest_369(Name, Stock).

invest_369(Name, Stock) :- 
    shareholder(Name, stock_369) => 
    (stock_up(stock_369) with 0.7) => 
    invest_370(Name, Stock).

invest_370(Name, Stock) :- 
    shareholder(Name, stock_370) => 
    (stock_up(stock_370) with 0.5) => 
    invest_371(Name, Stock).

invest_371(Name, Stock) :- 
    shareholder(Name, stock_371) => 
    (stock_up(stock_371) with 0.6) => 
    invest_372(Name, Stock).

invest_372(Name, Stock) :- 
    shareholder(Name, stock_372) => 
    (stock_up(stock_372) with 0.6) => 
    invest_373(Name, Stock).

invest_373(Name, Stock) :- 
    shareholder(Name, stock_373) => 
    (stock_up(stock_373) with 0.7) => 
    invest_374(Name, Stock).

invest_374(Name, Stock) :- 
    shareholder(Name, stock_374) => 
    (stock_up(stock_374) with 0.7) => 
    invest_375(Name, Stock).

invest_375(Name, Stock) :- 
    shareholder(Name, stock_375) => 
    (stock_up(stock_375) with 0.5) => 
    invest_376(Name, Stock).

invest_376(Name, Stock) :- 
    shareholder(Name, stock_376) => 
    (stock_up(stock_376) with 0.6) => 
    invest_377(Name, Stock).

invest_377(Name, Stock) :- 
    shareholder(Name, stock_377) => 
    (stock_up(stock_377) with 0.6) => 
    invest_378(Name, Stock).

invest_378(Name, Stock) :- 
    shareholder(Name, stock_378) => 
    (stock_up(stock_378) with 0.7) => 
    invest_379(Name, Stock).

invest_379(Name, Stock) :- 
    shareholder(Name, stock_379) => 
    (stock_up(stock_379) with 0.7) => 
    invest_380(Name, Stock).

invest_380(Name, Stock) :- 
    shareholder(Name, stock_380) => 
    (stock_up(stock_380) with 0.5) => 
    invest_381(Name, Stock).

invest_381(Name, Stock) :- 
    shareholder(Name, stock_381) => 
    (stock_up(stock_381) with 0.6) => 
    invest_382(Name, Stock).

invest_382(Name, Stock) :- 
    shareholder(Name, stock_382) => 
    (stock_up(stock_382) with 0.6) => 
    invest_383(Name, Stock).

invest_383(Name, Stock) :- 
    shareholder(Name, stock_383) => 
    (stock_up(stock_383) with 0.7) => 
    invest_384(Name, Stock).

invest_384(Name, Stock) :- 
    shareholder(Name, stock_384) => 
    (stock_up(stock_384) with 0.7) => 
    invest_385(Name, Stock).

invest_385(Name, Stock) :- 
    shareholder(Name, stock_385) => 
    (stock_up(stock_385) with 0.5) => 
    invest_386(Name, Stock).

invest_386(Name, Stock) :- 
    shareholder(Name, stock_386) => 
    (stock_up(stock_386) with 0.6) => 
    invest_387(Name, Stock).

invest_387(Name, Stock) :- 
    shareholder(Name, stock_387) => 
    (stock_up(stock_387) with 0.6) => 
    invest_388(Name, Stock).

invest_388(Name, Stock) :- 
    shareholder(Name, stock_388) => 
    (stock_up(stock_388) with 0.7) => 
    invest_389(Name, Stock).

invest_389(Name, Stock) :- 
    shareholder(Name, stock_389) => 
    (stock_up(stock_389) with 0.7) => 
    invest_390(Name, Stock).

invest_390(Name, Stock) :- 
    shareholder(Name, stock_390) => 
    (stock_up(stock_390) with 0.5) => 
    invest_391(Name, Stock).

invest_391(Name, Stock) :- 
    shareholder(Name, stock_391) => 
    (stock_up(stock_391) with 0.6) => 
    invest_392(Name, Stock).

invest_392(Name, Stock) :- 
    shareholder(Name, stock_392) => 
    (stock_up(stock_392) with 0.6) => 
    invest_393(Name, Stock).

invest_393(Name, Stock) :- 
    shareholder(Name, stock_393) => 
    (stock_up(stock_393) with 0.7) => 
    invest_394(Name, Stock).

invest_394(Name, Stock) :- 
    shareholder(Name, stock_394) => 
    (stock_up(stock_394) with 0.7) => 
    invest_395(Name, Stock).

invest_395(Name, Stock) :- 
    shareholder(Name, stock_395) => 
    (stock_up(stock_395) with 0.5) => 
    invest_396(Name, Stock).

invest_396(Name, Stock) :- 
    shareholder(Name, stock_396) => 
    (stock_up(stock_396) with 0.6) => 
    invest_397(Name, Stock).

invest_397(Name, Stock) :- 
    shareholder(Name, stock_397) => 
    (stock_up(stock_397) with 0.6) => 
    invest_398(Name, Stock).

invest_398(Name, Stock) :- 
    shareholder(Name, stock_398) => 
    (stock_up(stock_398) with 0.7) => 
    invest_399(Name, Stock).

invest_399(Name, Stock) :- 
    shareholder(Name, stock_399) => 
    (stock_up(stock_399) with 0.7) => 
    invest_400(Name, Stock).

invest_400(Name, Stock) :- 
    shareholder(Name, stock_400) => 
    (stock_up(stock_400) with 0.5) => 
    invest_401(Name, Stock).

invest_401(Name, Stock) :- 
    shareholder(Name, stock_401) => 
    (stock_up(stock_401) with 0.6) => 
    invest_402(Name, Stock).

invest_402(Name, Stock) :- 
    shareholder(Name, stock_402) => 
    (stock_up(stock_402) with 0.6) => 
    invest_403(Name, Stock).

invest_403(Name, Stock) :- 
    shareholder(Name, stock_403) => 
    (stock_up(stock_403) with 0.7) => 
    invest_404(Name, Stock).

invest_404(Name, Stock) :- 
    shareholder(Name, stock_404) => 
    (stock_up(stock_404) with 0.7) => 
    invest_405(Name, Stock).

invest_405(Name, Stock) :- 
    shareholder(Name, stock_405) => 
    (stock_up(stock_405) with 0.5) => 
    invest_406(Name, Stock).

invest_406(Name, Stock) :- 
    shareholder(Name, stock_406) => 
    (stock_up(stock_406) with 0.6) => 
    invest_407(Name, Stock).

invest_407(Name, Stock) :- 
    shareholder(Name, stock_407) => 
    (stock_up(stock_407) with 0.6) => 
    invest_408(Name, Stock).

invest_408(Name, Stock) :- 
    shareholder(Name, stock_408) => 
    (stock_up(stock_408) with 0.7) => 
    invest_409(Name, Stock).

invest_409(Name, Stock) :- 
    shareholder(Name, stock_409) => 
    (stock_up(stock_409) with 0.7) => 
    invest_410(Name, Stock).

invest_410(Name, Stock) :- 
    shareholder(Name, stock_410) => 
    (stock_up(stock_410) with 0.5) => 
    invest_411(Name, Stock).

invest_411(Name, Stock) :- 
    shareholder(Name, stock_411) => 
    (stock_up(stock_411) with 0.6) => 
    invest_412(Name, Stock).

invest_412(Name, Stock) :- 
    shareholder(Name, stock_412) => 
    (stock_up(stock_412) with 0.6) => 
    invest_413(Name, Stock).

invest_413(Name, Stock) :- 
    shareholder(Name, stock_413) => 
    (stock_up(stock_413) with 0.7) => 
    invest_414(Name, Stock).

invest_414(Name, Stock) :- 
    shareholder(Name, stock_414) => 
    (stock_up(stock_414) with 0.7) => 
    invest_415(Name, Stock).

invest_415(Name, Stock) :- 
    shareholder(Name, stock_415) => 
    (stock_up(stock_415) with 0.5) => 
    invest_416(Name, Stock).

invest_416(Name, Stock) :- 
    shareholder(Name, stock_416) => 
    (stock_up(stock_416) with 0.6) => 
    invest_417(Name, Stock).

invest_417(Name, Stock) :- 
    shareholder(Name, stock_417) => 
    (stock_up(stock_417) with 0.6) => 
    invest_418(Name, Stock).

invest_418(Name, Stock) :- 
    shareholder(Name, stock_418) => 
    (stock_up(stock_418) with 0.7) => 
    invest_419(Name, Stock).

invest_419(Name, Stock) :- 
    shareholder(Name, stock_419) => 
    (stock_up(stock_419) with 0.7) => 
    invest_420(Name, Stock).

invest_420(Name, Stock) :- 
    shareholder(Name, stock_420) => 
    (stock_up(stock_420) with 0.5) => 
    invest_421(Name, Stock).

invest_421(Name, Stock) :- 
    shareholder(Name, stock_421) => 
    (stock_up(stock_421) with 0.6) => 
    invest_422(Name, Stock).

invest_422(Name, Stock) :- 
    shareholder(Name, stock_422) => 
    (stock_up(stock_422) with 0.6) => 
    invest_423(Name, Stock).

invest_423(Name, Stock) :- 
    shareholder(Name, stock_423) => 
    (stock_up(stock_423) with 0.7) => 
    invest_424(Name, Stock).

invest_424(Name, Stock) :- 
    shareholder(Name, stock_424) => 
    (stock_up(stock_424) with 0.7) => 
    invest_425(Name, Stock).

invest_425(Name, Stock) :- 
    shareholder(Name, stock_425) => 
    (stock_up(stock_425) with 0.5) => 
    invest_426(Name, Stock).

invest_426(Name, Stock) :- 
    shareholder(Name, stock_426) => 
    (stock_up(stock_426) with 0.6) => 
    invest_427(Name, Stock).

invest_427(Name, Stock) :- 
    shareholder(Name, stock_427) => 
    (stock_up(stock_427) with 0.6) => 
    invest_428(Name, Stock).

invest_428(Name, Stock) :- 
    shareholder(Name, stock_428) => 
    (stock_up(stock_428) with 0.7) => 
    invest_429(Name, Stock).

invest_429(Name, Stock) :- 
    shareholder(Name, stock_429) => 
    (stock_up(stock_429) with 0.7) => 
    invest_430(Name, Stock).

invest_430(Name, Stock) :- 
    shareholder(Name, stock_430) => 
    (stock_up(stock_430) with 0.5) => 
    invest_431(Name, Stock).

invest_431(Name, Stock) :- 
    shareholder(Name, stock_431) => 
    (stock_up(stock_431) with 0.6) => 
    invest_432(Name, Stock).

invest_432(Name, Stock) :- 
    shareholder(Name, stock_432) => 
    (stock_up(stock_432) with 0.6) => 
    invest_433(Name, Stock).

invest_433(Name, Stock) :- 
    shareholder(Name, stock_433) => 
    (stock_up(stock_433) with 0.7) => 
    invest_434(Name, Stock).

invest_434(Name, Stock) :- 
    shareholder(Name, stock_434) => 
    (stock_up(stock_434) with 0.7) => 
    invest_435(Name, Stock).

invest_435(Name, Stock) :- 
    shareholder(Name, stock_435) => 
    (stock_up(stock_435) with 0.5) => 
    invest_436(Name, Stock).

invest_436(Name, Stock) :- 
    shareholder(Name, stock_436) => 
    (stock_up(stock_436) with 0.6) => 
    invest_437(Name, Stock).

invest_437(Name, Stock) :- 
    shareholder(Name, stock_437) => 
    (stock_up(stock_437) with 0.6) => 
    invest_438(Name, Stock).

invest_438(Name, Stock) :- 
    shareholder(Name, stock_438) => 
    (stock_up(stock_438) with 0.7) => 
    invest_439(Name, Stock).

invest_439(Name, Stock) :- 
    shareholder(Name, stock_439) => 
    (stock_up(stock_439) with 0.7) => 
    invest_440(Name, Stock).

invest_440(Name, Stock) :- 
    shareholder(Name, stock_440) => 
    (stock_up(stock_440) with 0.5) => 
    invest_441(Name, Stock).

invest_441(Name, Stock) :- 
    shareholder(Name, stock_441) => 
    (stock_up(stock_441) with 0.6) => 
    invest_442(Name, Stock).

invest_442(Name, Stock) :- 
    shareholder(Name, stock_442) => 
    (stock_up(stock_442) with 0.6) => 
    invest_443(Name, Stock).

invest_443(Name, Stock) :- 
    shareholder(Name, stock_443) => 
    (stock_up(stock_443) with 0.7) => 
    invest_444(Name, Stock).

invest_444(Name, Stock) :- 
    shareholder(Name, stock_444) => 
    (stock_up(stock_444) with 0.7) => 
    invest_445(Name, Stock).

invest_445(Name, Stock) :- 
    shareholder(Name, stock_445) => 
    (stock_up(stock_445) with 0.5) => 
    invest_446(Name, Stock).

invest_446(Name, Stock) :- 
    shareholder(Name, stock_446) => 
    (stock_up(stock_446) with 0.6) => 
    invest_447(Name, Stock).

invest_447(Name, Stock) :- 
    shareholder(Name, stock_447) => 
    (stock_up(stock_447) with 0.6) => 
    invest_448(Name, Stock).

invest_448(Name, Stock) :- 
    shareholder(Name, stock_448) => 
    (stock_up(stock_448) with 0.7) => 
    invest_449(Name, Stock).

invest_449(Name, Stock) :- 
    shareholder(Name, stock_449) => 
    (stock_up(stock_449) with 0.7) => 
    invest_450(Name, Stock).

invest_450(Name, Stock) :- 
    shareholder(Name, stock_450) => 
    (stock_up(stock_450) with 0.5) => 
    invest_451(Name, Stock).

invest_451(Name, Stock) :- 
    shareholder(Name, stock_451) => 
    (stock_up(stock_451) with 0.6) => 
    invest_452(Name, Stock).

invest_452(Name, Stock) :- 
    shareholder(Name, stock_452) => 
    (stock_up(stock_452) with 0.6) => 
    invest_453(Name, Stock).

invest_453(Name, Stock) :- 
    shareholder(Name, stock_453) => 
    (stock_up(stock_453) with 0.7) => 
    invest_454(Name, Stock).

invest_454(Name, Stock) :- 
    shareholder(Name, stock_454) => 
    (stock_up(stock_454) with 0.7) => 
    invest_455(Name, Stock).

invest_455(Name, Stock) :- 
    shareholder(Name, stock_455) => 
    (stock_up(stock_455) with 0.5) => 
    invest_456(Name, Stock).

invest_456(Name, Stock) :- 
    shareholder(Name, stock_456) => 
    (stock_up(stock_456) with 0.6) => 
    invest_457(Name, Stock).

invest_457(Name, Stock) :- 
    shareholder(Name, stock_457) => 
    (stock_up(stock_457) with 0.6) => 
    invest_458(Name, Stock).

invest_458(Name, Stock) :- 
    shareholder(Name, stock_458) => 
    (stock_up(stock_458) with 0.7) => 
    invest_459(Name, Stock).

invest_459(Name, Stock) :- 
    shareholder(Name, stock_459) => 
    (stock_up(stock_459) with 0.7) => 
    invest_460(Name, Stock).

invest_460(Name, Stock) :- 
    shareholder(Name, stock_460) => 
    (stock_up(stock_460) with 0.5) => 
    invest_461(Name, Stock).

invest_461(Name, Stock) :- 
    shareholder(Name, stock_461) => 
    (stock_up(stock_461) with 0.6) => 
    invest_462(Name, Stock).

invest_462(Name, Stock) :- 
    shareholder(Name, stock_462) => 
    (stock_up(stock_462) with 0.6) => 
    invest_463(Name, Stock).

invest_463(Name, Stock) :- 
    shareholder(Name, stock_463) => 
    (stock_up(stock_463) with 0.7) => 
    invest_464(Name, Stock).

invest_464(Name, Stock) :- 
    shareholder(Name, stock_464) => 
    (stock_up(stock_464) with 0.7) => 
    invest_465(Name, Stock).

invest_465(Name, Stock) :- 
    shareholder(Name, stock_465) => 
    (stock_up(stock_465) with 0.5) => 
    invest_466(Name, Stock).

invest_466(Name, Stock) :- 
    shareholder(Name, stock_466) => 
    (stock_up(stock_466) with 0.6) => 
    invest_467(Name, Stock).

invest_467(Name, Stock) :- 
    shareholder(Name, stock_467) => 
    (stock_up(stock_467) with 0.6) => 
    invest_468(Name, Stock).

invest_468(Name, Stock) :- 
    shareholder(Name, stock_468) => 
    (stock_up(stock_468) with 0.7) => 
    invest_469(Name, Stock).

invest_469(Name, Stock) :- 
    shareholder(Name, stock_469) => 
    (stock_up(stock_469) with 0.7) => 
    invest_470(Name, Stock).

invest_470(Name, Stock) :- 
    shareholder(Name, stock_470) => 
    (stock_up(stock_470) with 0.5) => 
    invest_471(Name, Stock).

invest_471(Name, Stock) :- 
    shareholder(Name, stock_471) => 
    (stock_up(stock_471) with 0.6) => 
    invest_472(Name, Stock).

invest_472(Name, Stock) :- 
    shareholder(Name, stock_472) => 
    (stock_up(stock_472) with 0.6) => 
    invest_473(Name, Stock).

invest_473(Name, Stock) :- 
    shareholder(Name, stock_473) => 
    (stock_up(stock_473) with 0.7) => 
    invest_474(Name, Stock).

invest_474(Name, Stock) :- 
    shareholder(Name, stock_474) => 
    (stock_up(stock_474) with 0.7) => 
    invest_475(Name, Stock).

invest_475(Name, Stock) :- 
    shareholder(Name, stock_475) => 
    (stock_up(stock_475) with 0.5) => 
    invest_476(Name, Stock).

invest_476(Name, Stock) :- 
    shareholder(Name, stock_476) => 
    (stock_up(stock_476) with 0.6) => 
    invest_477(Name, Stock).

invest_477(Name, Stock) :- 
    shareholder(Name, stock_477) => 
    (stock_up(stock_477) with 0.6) => 
    invest_478(Name, Stock).

invest_478(Name, Stock) :- 
    shareholder(Name, stock_478) => 
    (stock_up(stock_478) with 0.7) => 
    invest_479(Name, Stock).

invest_479(Name, Stock) :- 
    shareholder(Name, stock_479) => 
    (stock_up(stock_479) with 0.7) => 
    invest_480(Name, Stock).

invest_480(Name, Stock) :- 
    shareholder(Name, stock_480) => 
    (stock_up(stock_480) with 0.5) => 
    invest_481(Name, Stock).

invest_481(Name, Stock) :- 
    shareholder(Name, stock_481) => 
    (stock_up(stock_481) with 0.6) => 
    invest_482(Name, Stock).

invest_482(Name, Stock) :- 
    shareholder(Name, stock_482) => 
    (stock_up(stock_482) with 0.6) => 
    invest_483(Name, Stock).

invest_483(Name, Stock) :- 
    shareholder(Name, stock_483) => 
    (stock_up(stock_483) with 0.7) => 
    invest_484(Name, Stock).

invest_484(Name, Stock) :- 
    shareholder(Name, stock_484) => 
    (stock_up(stock_484) with 0.7) => 
    invest_485(Name, Stock).

invest_485(Name, Stock) :- 
    shareholder(Name, stock_485) => 
    (stock_up(stock_485) with 0.5) => 
    invest_486(Name, Stock).

invest_486(Name, Stock) :- 
    shareholder(Name, stock_486) => 
    (stock_up(stock_486) with 0.6) => 
    invest_487(Name, Stock).

invest_487(Name, Stock) :- 
    shareholder(Name, stock_487) => 
    (stock_up(stock_487) with 0.6) => 
    invest_488(Name, Stock).

invest_488(Name, Stock) :- 
    shareholder(Name, stock_488) => 
    (stock_up(stock_488) with 0.7) => 
    invest_489(Name, Stock).

invest_489(Name, Stock) :- 
    shareholder(Name, stock_489) => 
    (stock_up(stock_489) with 0.7) => 
    invest_490(Name, Stock).

invest_490(Name, Stock) :- 
    shareholder(Name, stock_490) => 
    (stock_up(stock_490) with 0.5) => 
    invest_491(Name, Stock).

invest_491(Name, Stock) :- 
    shareholder(Name, stock_491) => 
    (stock_up(stock_491) with 0.6) => 
    invest_492(Name, Stock).

invest_492(Name, Stock) :- 
    shareholder(Name, stock_492) => 
    (stock_up(stock_492) with 0.6) => 
    invest_493(Name, Stock).

invest_493(Name, Stock) :- 
    shareholder(Name, stock_493) => 
    (stock_up(stock_493) with 0.7) => 
    invest_494(Name, Stock).

invest_494(Name, Stock) :- 
    shareholder(Name, stock_494) => 
    (stock_up(stock_494) with 0.7) => 
    invest_495(Name, Stock).

invest_495(Name, Stock) :- 
    shareholder(Name, stock_495) => 
    (stock_up(stock_495) with 0.5) => 
    invest_496(Name, Stock).

invest_496(Name, Stock) :- 
    shareholder(Name, stock_496) => 
    (stock_up(stock_496) with 0.6) => 
    invest_497(Name, Stock).

invest_497(Name, Stock) :- 
    shareholder(Name, stock_497) => 
    (stock_up(stock_497) with 0.6) => 
    invest_498(Name, Stock).

invest_498(Name, Stock) :- 
    shareholder(Name, stock_498) => 
    (stock_up(stock_498) with 0.7) => 
    invest_499(Name, Stock).

invest_499(Name, Stock) :- 
    shareholder(Name, stock_499) => 
    (stock_up(stock_499) with 0.7) => 
    invest_500(Name, Stock).

invest_500(Name, Stock) :- 
    shareholder(Name, stock_500) => 
    (stock_up(stock_500) with 0.5) => 
